    ...
    <div class="col-xl-10">
        <div class="card style--two">
            <div class="card-header">
                ...
                <h3 class="fw-normal float-end"><a href="{{ route('user.withdraw') }}"
                        class="btn btn-outline--primary btn-sm"> <i class="las la-backward"></i> @lang('Withdraw Money')</a></h3>
            </div>
            <div class="card-body px-sm-5 py-sm-4">
                <div class="row gy-4">
                    <div class="col-lg-6">
                        <div class="bank-card add-bank align-items-center rounded-3 has--link">
                            <a href="{{ route('user.withdraw.method.add.page') }}" class="item--link"></a>
                    ...
                    @forelse ($userMethods as $method)
                        <div class="col-lg-6">
                            <div class="bank-card  align-items-center rounded-3 has--link">
                                <a href="{{ route('user.withdraw.edit', $method->id) }}" class="item--link withdraw"></a>
