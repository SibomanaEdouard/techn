    ...
    <div class="col-12">
        <div class="card custom--card border-0">
            ...
            <div class="card-body p-0"> 
                <form class="transaction-top-form my-3 px-3" action="" method="GET">
                    <div class="custom-select-search-box">
                        <input type="text" name="search" value="{{ request()->search }}" class="form--control" placeholder="@lang('Search by transaction ID')" required>
                ...
                <div class="row gy-3 gx-3 p-3">
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two">
                            ...
                            <select onChange="window.location.href=this.value">
                                ...
                                <option value="{{ queryBuild('type', 'plus_trx') }}"
                                    {{ request('type') == 'plus_trx' ? 'selected' : '' }}>@lang('Plus Transactions')
                                </option>
                                <option value="{{ queryBuild('type', 'minus_trx') }}"
                                    {{ request('type') == 'minus_trx' ? 'selected' : '' }}>@lang('Minus Transactions')
                                </option>
                            </select>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two">
                            ...
                            <select onChange="window.location.href=this.value">
                                <option value="{{ queryBuild('operation', '') }}"
                                    {{ request('operation') == '' ? 'selected' : '' }}>@lang('All Operation')
                                </option>
                                <option value="{{ queryBuild('operation', 'add_money') }}"
                                    {{ request('operation') == 'add_money' ? 'selected' : '' }}>@lang('Add Money')
                                </option>
                                <option value="{{ queryBuild('operation', 'money_out') }}"
                                    {{ request('operation') == 'money_out' ? 'selected' : '' }}>@lang('Money Out')
                                </option>
                                <option value="{{ queryBuild('operation', 'transfer_money') }}"
                                    {{ request('operation') == 'transfer_money' ? 'selected' : '' }}>@lang('Transfer Money')
                                </option>
                                <option value="{{ queryBuild('operation', 'request_money') }}"
                                    {{ request('operation') == 'request_money' ? 'selected' : '' }}>@lang('Request Money')
                                </option>
                                <option value="{{ queryBuild('operation', 'make_payment') }}"
                                    {{ request('operation') == 'make_payment' ? 'selected' : '' }}>@lang('Make Payment')
                                </option>
                                <option value="{{ queryBuild('operation', 'exchange_money') }}"
                                    {{ request('operation') == 'exchange_money' ? 'selected' : '' }}>@lang('Exchange Money')
                                </option>
                                <option value="{{ queryBuild('operation', 'create_voucher') }}"
                                    {{ request('operation') == 'create_voucher' ? 'selected' : '' }}>@lang('Create Voucher')
                                </option>
                                <option value="{{ queryBuild('operation', 'withdraw') }}"
                                    {{ request('operation') == 'withdraw' ? 'selected' : '' }}>@lang('Withdraw Money')
                                </option>
                                <option value="{{ queryBuild('operation', 'balance_add') }}"
                                    {{ request('operation') == 'balance_add' ? 'selected' : '' }}>@lang('Add By System')
                                </option>
                                <option value="{{ queryBuild('operation', 'balance_subtract') }}"
                                    {{ request('operation') == 'balance_subtract' ? 'selected' : '' }}>@lang('Subtract By System')
                                </option>
                            </select> 
                        </div><!-- custom-select-box-two end -->
                    </div>
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two">
                            ...
                            <select onChange="window.location.href=this.value">
                                <option value="{{ queryBuild('time', '') }}" {{ request('time') == '' ? 'selected' : '' }}>
                                    @lang('All Time')
                                </option>
                                <option value="{{ queryBuild('time', '7days') }}" {{ request('time') == '7days' ? 'selected' : '' }}>
                                    @lang('Last 7 days')
                                </option>
                                <option value="{{ queryBuild('time', '15days') }}" {{ request('time') == '15days' ? 'selected' : '' }}>
                                    @lang('Last 15 days')
                                </option>
                                <option value="{{ queryBuild('time', '1month') }}" {{ request('time') == '1month' ? 'selected' : '' }}>
                                    @lang('Last month')
                                </option>
                                <option value="{{ queryBuild('time', '1year') }}" {{ request('time') == '1year' ? 'selected' : '' }}>
                                    @lang('Last Year')
                                </option>
                            </select>
                        </div><!-- custom-select-box-two end -->
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4">
                        <div class="custom-select-box-two">
                            ...
                            <select onChange="window.location.href=this.value">
                                <option value="{{ queryBuild('currency', '') }}"
                                    {{ request('currency') == '' ? 'selected' : '' }}>@lang('All Currency')
                                </option>
                                        ...
                                        <div class="left">
                                            ...
                                            <div class="content">
                                                <h6 class="trans-title">
                                                    {{ __(ucwords(str_replace('_', ' ', $history->remark))) }}</h6>
            ...
            @if($transactions->hasPages())
                <div class="card-footer bg-transparent pt-5 pb-3">
