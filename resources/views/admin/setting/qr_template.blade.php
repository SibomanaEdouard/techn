        ...
        <div class="custom">
            <div class="file_upload">
                ...
                <form class="form-data border-primary" enctype="multipart/form-data" id="form" method="post">
                    @csrf
                    <input class="file-input form-control" type="file" name="qr_code_template" id="file-input" hidden accept=".png, .jpg, .jpeg, .webp">
                    <i class="fas fa-cloud-upload-alt text--primary"></i>
                    <p class="text--dark">@lang('Click here to upload')</p>
                    <small class="text-center mb-2">(@lang('Supported files: jpeg, jpg., .png, .webp Image will be resized into') {{ getFileSize('qr_code_template') }})</small>
                </form>
